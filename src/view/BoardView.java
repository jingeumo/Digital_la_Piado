            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    if (boards.isEmpty()) {
                        ...
                        System.out.println("[1. 게시글 작성, 2. 게시글 출력 -1 : 돌아가기] : -1");
                    } else {
                        System.out.println("--------------------------[ 게시글 출력 ]---------------------------");
                        for (BoardDto board : boards) {
                            System.out.println("게시글 번호 : " + board.getId() + ", 작성자 : " + board.getAuthor() + ", 게시글 제목 : " + board.getTitle());
                        }
                        System.out.println("[1. 게시글 작성, 2. 게시글 출력, 3. 게시글 선택 : 4. 게시글 수정 5. 게시글 삭제 -1 : 돌아가기] : ");
                ...
                case 4:
                    ...
                    System.out.println("등급 : " + (userType == 1 ? "개인" : "아티스트"));
